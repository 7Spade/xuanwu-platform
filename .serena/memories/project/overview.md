...
- **Modular DDD + Hexagonal Architecture**: See `docs/architecture/notes/model-driven-hexagonal-architecture.md`. Domain Modules live in `src/modules/<name>.module/`; each is a Bounded Context with 4-layer dependency direction: Presentation → Application → Domain ← Infrastructure.
