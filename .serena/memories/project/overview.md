...
- **Modular DDD + Hexagonal Architecture**: See `model-driven-hexagonal-architecture.md`. Domain Modules live in `src/modules/<name>.module/`; each is a Bounded Context with 4 layers (Domain → Application → Infrastructure → Presentation).
